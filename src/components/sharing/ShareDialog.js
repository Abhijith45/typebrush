...
export default function ShareDialog({ isOpen, onClose, shareContent }) {
  ...
  const { text, url, fullCopyText } = shareContent;
  ...
  return (
    ...
    >
      ...
      >
        <Typography component="p" sx={{ margin: 0, fontWeight: "500", fontSize: "0.9rem" }}>
          {text}
        </Typography>
        <Typography
          component="p"
          sx={{ margin: "0.5rem 0 0 0", fontSize: "0.85rem", color: "var(--accent-color)", fontWeight: "600" }}
        >
          {url}
        </Typography>
      </Box>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        <Typography
          component="span"
          sx={{ fontSize: "0.85rem", fontWeight: "600", color: "var(--sub-color)" }}
        >
          Share to platform:
        </Typography>
      ...
      {copyError && (
        <Typography
          component="span"
          sx={{ fontSize: "0.8rem", color: "#ef4444", textAlign: "center" }}
        >
