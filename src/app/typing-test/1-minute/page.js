...
export const metadata = {
  title: "1-Minute Typing Test | Quick Speed & WPM Test",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
      ...
      <div className="placeholder-box">
        <p className="placeholder-text">⌨️ 1-Minute Typing Test Interface</p>
      ...
      <section className="card">
        <h2 style={{ fontSize: "1.25rem", color: "var(--accent-color)", marginBottom: "0.5rem" }}>Why take a 1-minute test?</h2>
        <p style={{ fontSize: "0.95rem", opacity: 0.8, marginBottom: "1rem" }}>
          The 1-minute typing test is the most popular test length. It lets you quickly warm up, measure your baseline words-per-minute (WPM), and identify immediate key positioning errors without getting tired.
        </p>
